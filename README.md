Middleware in Express.js is a function that is executed between the time a request is received by the server and the time a response is sent back to the client. 
